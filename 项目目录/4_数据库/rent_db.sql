...
-- ----------------------------
-- Table structure for `r_cancel`
-- ----------------------------
DROP TABLE IF EXISTS `r_cancel`;
CREATE TABLE `r_cancel` (
  `cancelId` int(11) NOT NULL AUTO_INCREMENT,
  `orderId` int(11) NOT NULL,
  `cancelDate` varchar(50) NOT NULL,
  `guestRefund` double NOT NULL,
  `ownerRefund` double NOT NULL,
  PRIMARY KEY (`cancelId`),
  KEY `fk_cancel_order` (`orderId`),
  CONSTRAINT `fk_cancel_order` FOREIGN KEY (`orderId`) REFERENCES `r_order` (`orderId`)
...
-- ----------------------------
-- Table structure for `r_fac`
-- ----------------------------
DROP TABLE IF EXISTS `r_fac`;
CREATE TABLE `r_fac` (
  `facId` int(11) NOT NULL AUTO_INCREMENT,
  `facName` varchar(255) NOT NULL,
  `facTypeId` int(11) NOT NULL,
  PRIMARY KEY (`facId`),
  KEY `fk_fac_facType` (`facTypeId`),
  CONSTRAINT `fk_fac_facType` FOREIGN KEY (`facTypeId`) REFERENCES `r_factype` (`facTypeId`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_fac
-- ----------------------------
INSERT INTO `r_fac` VALUES ('1', '双人床', '1');
INSERT INTO `r_fac` VALUES ('2', '单人床', '1');
INSERT INTO `r_fac` VALUES ('3', '卫生间', '1');
INSERT INTO `r_fac` VALUES ('4', '生活必需品', '2');
INSERT INTO `r_fac` VALUES ('5', '无线网络', '2');
INSERT INTO `r_fac` VALUES ('6', '电视', '2');
INSERT INTO `r_fac` VALUES ('7', '暖气', '2');
INSERT INTO `r_fac` VALUES ('8', '空调', '2');
INSERT INTO `r_fac` VALUES ('9', '早餐', '2');
INSERT INTO `r_fac` VALUES ('10', '吹风机', '2');
INSERT INTO `r_fac` VALUES ('11', '熨斗', '2');
INSERT INTO `r_fac` VALUES ('12', '烟雾报警器', '3');
INSERT INTO `r_fac` VALUES ('13', '急救包', '3');
INSERT INTO `r_fac` VALUES ('14', '灭火器', '3');
INSERT INTO `r_fac` VALUES ('15', '游泳池', '4');
INSERT INTO `r_fac` VALUES ('16', '厨房', '4');
INSERT INTO `r_fac` VALUES ('17', '洗衣机', '4');
INSERT INTO `r_fac` VALUES ('18', '停车位', '4');
INSERT INTO `r_fac` VALUES ('19', '电梯', '4');
INSERT INTO `r_fac` VALUES ('20', '健身房', '4');

-- ----------------------------
-- Table structure for `r_factype`
-- ----------------------------
DROP TABLE IF EXISTS `r_factype`;
CREATE TABLE `r_factype` (
  `facTypeId` int(11) NOT NULL AUTO_INCREMENT,
  `facTypeName` varchar(20) NOT NULL,
  PRIMARY KEY (`facTypeId`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_factype
-- ----------------------------
INSERT INTO `r_factype` VALUES ('1', '基础设施');
INSERT INTO `r_factype` VALUES ('2', '便利设施');
INSERT INTO `r_factype` VALUES ('3', '安全设施');
INSERT INTO `r_factype` VALUES ('4', '公共设施');

-- ----------------------------
-- Table structure for `r_house`
-- ----------------------------
DROP TABLE IF EXISTS `r_house`;
CREATE TABLE `r_house` (
  `houseId` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
  `housePic` varchar(500) DEFAULT NULL,
  `areaid` int(11) NOT NULL,
  `houseAdress` varchar(100) DEFAULT NULL,
  `houseTitle` varchar(50) NOT NULL,
  `houseImfo` text,
  `houseTypeId` int(11) NOT NULL,
  `houseHeat` int(11) NOT NULL,
  `housePrice` double NOT NULL,
  `houseScore` double DEFAULT NULL,
  `houseStatusId` int(11) NOT NULL,
  `houseTime` varchar(100) DEFAULT NULL,
  `maxGuestNum` int(11) NOT NULL,
  PRIMARY KEY (`houseId`),
  KEY `fk_house_user` (`userId`),
  KEY `fk_house_houseType` (`houseTypeId`),
  KEY `fk_house_houseStatus` (`houseStatusId`),
  CONSTRAINT `fk_house_houseStatus` FOREIGN KEY (`houseStatusId`) REFERENCES `r_housestatus` (`houseStatusId`),
  CONSTRAINT `fk_house_houseType` FOREIGN KEY (`houseTypeId`) REFERENCES `r_housetype` (`houseTypeId`),
  CONSTRAINT `fk_house_user` FOREIGN KEY (`userId`) REFERENCES `r_user` (`userId`)
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_house
-- ----------------------------
INSERT INTO `r_house` VALUES ('101', '27', '/houseImg/19dfc81b9d11fc06bcae59cb155b4345_1564565262192.jpg', '230505', '123号', '房源1', '<p>暂无房源说明</p><p><img src=\"/CosmoSuper/image/20190731/1564565207840082492.jpg\" style=\"width: 529px; height: 470px;\" title=\"1564565207840082492.jpg\" width=\"529\" height=\"470\"/></p><p><img src=\"/CosmoSuper/image/20190731/1564565207840059835.jpg\" style=\"width: 506px; height: 440px;\" title=\"1564565207840059835.jpg\" width=\"506\" height=\"440\"/></p><p>朝阳，舒适<br/></p>', '1', '20', '300', '5', '1', '2019年07月31日05:25:12', '5');
INSERT INTO `r_house` VALUES ('102', '26', '/houseImg/IMG_3631_1564568238060.JPG', '130901', '福建工程学院', '蜜桃之夏 | 希腊度假风情屋×超清投影', '<p><img src=\"/CosmoSuper/image/20190731/1564567772105045479.jpg\" style=\"width: 480px; height: 522px;\" title=\"1564567772105045479.jpg\" width=\"480\" height=\"522\"/></p><p><img src=\"/CosmoSuper/image/20190731/1564567772105057890.jpg\" style=\"width: 445px; height: 361px;\" title=\"1564567772105057890.jpg\" width=\"445\" height=\"361\"/></p><p><br/></p><p>房源<br/></p><p><br/></p>', '1', '33', '100', '5', '1', '2019年07月31日06:31:27', '1');
INSERT INTO `r_house` VALUES ('103', '27', '/houseImg/IMG_3630_1564570098046.JPG', '130101', '朝阳', 'R6 三亚湾大东海解放路轻奢设计师', '<p><img src=\"/CosmoSuper/image/20190731/1564569872751022507.jpg\" style=\"width: 501px; height: 339px;\" title=\"1564569872751022507.jpg\" width=\"501\" height=\"339\"/></p><p><img src=\"/CosmoSuper/image/20190731/1564569872755071810.jpg\" style=\"width: 496px; height: 210px;\" title=\"1564569872755071810.jpg\" width=\"496\" height=\"210\"/></p><p><br/></p>', '2', '4', '339', '5', '1', '2019年07月31日06:40:51', '3');
INSERT INTO `r_house` VALUES ('104', '28', null, '350201', '软件园一楼食堂仓库', '房源', '暂无房源说明', '1', '3', '798', '5', '4', '2019年07月31日06:51:14', '4');
INSERT INTO `r_house` VALUES ('105', '27', '/houseImg/19dfc81b9d11fc06bcae59cb155b4345_1564570742686.jpg', '140301', '郊区', '房源', '<p><img src=\"/CosmoSuper/image/20190731/1564570701728096566.jpg\" title=\"1564570701728096566.jpg\" alt=\"2.jpg\" width=\"430\" height=\"432\" style=\"width: 430px; height: 432px;\"/></p><p><img src=\"/CosmoSuper/image/20190731/1564570227399055765.jpg\" style=\"width: 410px; height: 410px;\" title=\"1564570227399055765.jpg\" width=\"410\" height=\"410\"/></p><p><br/></p>', '3', '5', '699', '5', '1', '2019年07月31日06:57:05', '9');
INSERT INTO `r_house` VALUES ('106', '26', '/houseImg/aecc9790_original_1564622010055.jpg', '140203', '福建工程学院', 'Super Cute Retro Airstream', '<p>概要</p><p class=\"_6z3til\"><span class=\"_11dqbld7\">Book\r\n a couple of nights with us and experience glamping in the Texas hill \r\ncountry! With a hot tub, fire pit, outdoor shower, basic kitchen, queen \r\nbed, wifi, TV, small library of western movies, and 10 beautiful \r\ncreekside acres, this trailer is a hit no matter what the season or the \r\nweather. Our retro Airstream has been featured in many Texas travel \r\nlists and magazine articles (Southern Living, Apt Therapy, Dallas \r\nMorning News, The Sun (UK), Outside Magazine and more). Come stay a \r\nspell...</span></p><p>房源细节</p><p class=\"_6z3til\"><span class=\"_11dqbld7\">Do\r\n you ever daydream about jumping in a travel trailer and heading west? &nbsp;\r\nAre you enamored with the vintage style of a bygone era? &nbsp;Do you enjoy \r\ncamping, but secretly wish you had a real bed, wifi and a bathroom? &nbsp;If \r\nso, the Dixie Daisy is for you! &nbsp;This cute Airstream trailer has been \r\ncompletely renovated with a retro twist. &nbsp;It’s the perfect place to \r\nescape for a relaxing weekend surrounded by nature, yet equipped with \r\nthe conveniences of home. &nbsp;Grill up a yummy dinner with your honey and \r\ndine al fresco on the large deck, take a morning stroll along the creek,\r\n turn on the string lights for some mood lighting, take a dip in the hot\r\n tub, enjoy your morning shower under the trees in the private, spacious\r\n outdoor shower (room for two!), and end your day relaxing by the fire \r\nwith an ice cold beer. &nbsp;This is the life! &nbsp;</span></p><p class=\"_6z3til\"><span class=\"_11dqbld7\">The\r\n Dixie Daisy provides all the comforts of home in one cute, cozy \r\npackage. &nbsp;The antique iron bedframe holds a queen mattress, the bathroom\r\n has a small interior shower and a real toilet, the kitchen is fully \r\nequipped with dishes and utensils, and alongside the deck is a charcoal \r\ngrill and fire bowl for your night-time fire. The owners really go out \r\nof their way to add those special touches to make your trip complete, \r\nsuch as leaving fresh eggs in the fridge (as long as the chickens keep \r\nup) and local organic coffee. &nbsp; They also strive to make this property \r\nas green as possible by using environmentally friendly dish soap and \r\nlaundry detergent, providing recycled paper products and full recycling,\r\n using low-wattage light bulbs, and more.</span></p><p class=\"_6z3til\"><span class=\"_11dqbld7\">This\r\n cozy retreat is nestled in an elm grove along the banks of Smith Creek \r\non 10 beautiful acres shared with the owners. You’ll really feel like \r\nyou’ve escaped to nature, yet the fabulous shopping and dining of \r\ndowntown Wimberley are only 3 miles down the road. &nbsp;It’s the best of \r\nboth worlds! &nbsp;So, what are you waiting for? &nbsp;The Dixie Daisy is the \r\nunique getaway you’ve been dreaming of. &nbsp;We are confident that it will \r\nexceed your expectations!</span></p><p class=\"_6z3til\"><span class=\"_11dqbld7\"><br/></span></p><p class=\"_6z3til\"><span class=\"_11dqbld7\">内部细节</span></p><p class=\"_6z3til\"><span class=\"_11dqbld7\"><img src=\"/CosmoSuper/image/20190801/1564621910211051602.jpg\" title=\"1564621910211051602.jpg\" alt=\"33aad889_original.jpg\" style=\"width: 479px; height: 342px;\" width=\"479\" height=\"342\"/></span></p><p><br/></p>', '2', '8', '200', '5', '1', '2019年07月31日08:53:53', '1');
INSERT INTO `r_house` VALUES ('107', '27', null, '120101', '和平区', '房源', '暂无房源说明', '1', '6', '288', '5', '4', '2019年08月01日08:10:22', '4');
INSERT INTO `r_house` VALUES ('108', '26', '/houseImg/IMG_3627_1564645501579.JPG', '230601', '福建工程学院', 'Stey 共享居住空间「胡同里的设计酒店Studio」步行可达故宫&王府井，适合差旅', '<p><img src=\"/CosmoSuper/image/20190801/1564645368687003104.jpg\" style=\"width: 503px; height: 482px;\" title=\"1564645368687003104.jpg\" width=\"503\" height=\"482\"/></p><p><img src=\"/CosmoSuper/image/20190801/1564645368687011923.jpg\" style=\"width: 1px; height: 1px;\" title=\"1564645368687011923.jpg\" width=\"1\" height=\"1\"/></p><p><br/></p>', '7', '9', '102', '5', '1', '2019年08月01日08:23:00', '1');
INSERT INTO `r_house` VALUES ('109', '26', '/houseImg/1_1564620191777.jpg', '110101', '北京', '【小明的家】国贸CBD附近北欧简约智能家居', '', '2', '4', '300', '5', '1', '2019年08月01日08:24:25', '1');
INSERT INTO `r_house` VALUES ('110', '26', '/houseImg/1_1564620599102.jpg', '110101', '北京', '塗蘼画室的艺术之屋 (直达大悦城天街东四南锣鼓巷后海北海公园）可免费画画', '', '7', '1', '200', '5', '1', '2019年08月01日08:25:29', '1');
INSERT INTO `r_house` VALUES ('111', '26', '/houseImg/1_1564620640173.jpg', '110101', '北京', 'Stey 共享居住空间「胡同里的设计酒店Studio」步行可达故宫&王府井，适合差旅', '<p>暂无房源说明</p>', '2', '1', '450', '5', '1', '2019年08月01日08:25:55', '1');
INSERT INTO `r_house` VALUES ('112', '26', '/houseImg/1_1564620688042.jpg', '340101', '北京', '【夏季特惠】毗邻双井国贸、欢乐谷的现代文艺公寓 大飘窗 楼下@地铁口', '<p>暂无房源说明</p>', '12', '1', '200', '5', '1', '2019年08月01日08:26:19', '1');
INSERT INTO `r_house` VALUES ('113', '26', null, '110101', '北京', '房源', '暂无房源说明', '1', '2', '200', '5', '4', '2019年08月01日08:26:39', '1');
INSERT INTO `r_house` VALUES ('114', '26', null, '130301', '北京', '房源', '暂无房源说明', '2', '0', '300', '5', '4', '2019年08月01日08:28:02', '1');
INSERT INTO `r_house` VALUES ('115', '28', null, '320503', '这个那个街', '房源', '暂无房源说明', '8', '0', '570', '5', '4', '2019年08月01日08:28:12', '2');
INSERT INTO `r_house` VALUES ('116', '26', null, '110101', '北京', '房源', '暂无房源说明', '2', '0', '200', '5', '4', '2019年08月01日08:29:03', '1');
INSERT INTO `r_house` VALUES ('117', '28', null, '320506', '那个这个那个街', '房源', '暂无房源说明', '5', '0', '1050', '5', '4', '2019年08月01日08:29:20', '3');
INSERT INTO `r_house` VALUES ('118', '26', null, '150101', '上海', '房源', '暂无房源说明', '6', '0', '200', '5', '4', '2019年08月01日08:29:26', '1');
INSERT INTO `r_house` VALUES ('119', '26', null, '150101', '上海', '房源', '暂无房源说明', '7', '0', '1', '5', '4', '2019年08月01日08:29:56', '1');
INSERT INTO `r_house` VALUES ('120', '28', null, '320582', '吴中路22号', '房源', '暂无房源说明', '4', '0', '335', '5', '4', '2019年08月01日08:30:09', '4');
INSERT INTO `r_house` VALUES ('121', '26', null, '110101', '北京', '房源', '暂无房源说明', '11', '0', '1', '5', '4', '2019年08月01日08:30:14', '1');
INSERT INTO `r_house` VALUES ('122', '26', null, '230101', '上海', '房源', '暂无房源说明', '12', '0', '133', '5', '4', '2019年08月01日08:30:35', '1');
INSERT INTO `r_house` VALUES ('123', '28', null, '320585', '毕夜路', '房源', '暂无房源说明', '8', '0', '170', '5', '4', '2019年08月01日08:30:53', '2');
INSERT INTO `r_house` VALUES ('124', '26', null, '110101', '北京', '房源', '暂无房源说明', '12', '0', '888', '5', '4', '2019年08月01日08:31:07', '1');
INSERT INTO `r_house` VALUES ('125', '28', null, '320503', '石溪路', '房源', '暂无房源说明', '1', '0', '220', '5', '4', '2019年08月01日08:32:19', '4');
INSERT INTO `r_house` VALUES ('126', '26', null, '320102', '南京', '房源', '暂无房源说明', '2', '0', '1', '5', '4', '2019年08月01日08:32:34', '1');
INSERT INTO `r_house` VALUES ('127', '28', null, '320507', '贝弗利山庄', '房源', '暂无房源说明', '2', '0', '900', '5', '4', '2019年08月01日08:33:02', '6');
INSERT INTO `r_house` VALUES ('128', '26', null, '320101', '南京', '房源', '暂无房源说明', '7', '0', '2', '5', '4', '2019年08月01日08:33:06', '1');
INSERT INTO `r_house` VALUES ('129', '26', '/houseImg/1_1564621244187.jpg', '320101', '南京', '当代艺术|肉桂色•339/太古里/LOFT榻榻米|独套/井已美宿A房', '<p>暂无房源说明</p>', '7', '1', '200', '5', '1', '2019年08月01日08:33:37', '1');
INSERT INTO `r_house` VALUES ('130', '26', '/houseImg/4_1564621194202.jpg', '320103', '南京', '留白 清新北欧风 靠近地铁站 地铁3、4号线市二医院站可到达 走路可到太古里 春熙路哦', '<p>暂无房源说明</p>', '11', '2', '333', '5', '1', '2019年08月01日08:34:34', '1');
INSERT INTO `r_house` VALUES ('131', '26', '/houseImg/1_1564621126846.jpg', '320103', '南京', 'MOHUANG|对面就是太古里春熙路和地铁站 下楼就吃小龙坎', '<p>暂无房源说明</p>', '2', '1', '888', '5', '1', '2019年08月01日08:35:06', '1');
INSERT INTO `r_house` VALUES ('132', '26', '/houseImg/1_1564621086603.jpg', '330103', '南京', '「Blues」北欧艺术家惬意阳光|紧邻北京站天坛公园 王府井天安门 20分钟工体三里屯 广渠门', '<p>暂无房源说明</p>', '2', '1', '234', '5', '1', '2019年08月01日08:35:31', '1');
INSERT INTO `r_house` VALUES ('133', '27', null, '140106', '迎泽区', '房源', '暂无房源说明', '7', '0', '299', '5', '4', '2019年08月01日08:36:46', '3');
INSERT INTO `r_house` VALUES ('134', '26', '/houseImg/default_house.jpg', '150101', '杭州', '房源', '暂无房源说明', '1', '0', '3', '5', '4', '2019年08月01日09:48:24', '1');
INSERT INTO `r_house` VALUES ('135', '49', '/houseImg/IMG_3623_1564627418456.JPG', '350203', '11', '房源', '<p>暂无房源说明<img src=\"/CosmoSuper/image/20190801/1564627387463016320.jpg\" title=\"1564627387463016320.jpg\" alt=\"IMG_3628.jpg\" style=\"width: 555px; height: 483px;\" width=\"555\" height=\"483\"/></p>', '7', '1', '200', '5', '1', '2019年08月01日10:41:38', '1');
INSERT INTO `r_house` VALUES ('136', '26', '/houseImg/default_house.jpg', '140311', '四大', '房源', '暂无房源说明', '2', '0', '5', '5', '4', '2019年08月01日11:38:29', '1');
INSERT INTO `r_house` VALUES ('137', '26', '/houseImg/default_house.jpg', '310101', '第三方', '房源', '暂无房源说明', '7', '0', '3', '5', '4', '2019年08月01日03:36:13', '1');

-- ----------------------------
-- Table structure for `r_housecomt`
-- ----------------------------
DROP TABLE IF EXISTS `r_housecomt`;
CREATE TABLE `r_housecomt` (
  `hComtId` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
  `hComtScore` double NOT NULL,
  `hComtText` text NOT NULL,
  `houseId` int(11) NOT NULL,
  `hComtTime` varchar(100) NOT NULL,
  PRIMARY KEY (`hComtId`),
  KEY `fk_houseComt_house` (`houseId`),
  KEY `fk_houseComt_user` (`userId`),
  CONSTRAINT `fk_houseComt_house` FOREIGN KEY (`houseId`) REFERENCES `r_house` (`houseId`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_houseComt_user` FOREIGN KEY (`userId`) REFERENCES `r_user` (`userId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_housecomt
-- ----------------------------
INSERT INTO `r_housecomt` VALUES ('34', '28', '4', '牛皮！！！！', '102', '2019年7月31日18:22:59');
INSERT INTO `r_housecomt` VALUES ('35', '26', '4', 'urrsys n', '102', '2019年7月31日18:30:43');
INSERT INTO `r_housecomt` VALUES ('36', '26', '4', 'hhh', '102', '2019年8月1日10:50:46');

-- ----------------------------
-- Table structure for `r_housefac`
-- ----------------------------
DROP TABLE IF EXISTS `r_housefac`;
CREATE TABLE `r_housefac` (
  `houseId` int(11) NOT NULL,
  `facId` int(11) NOT NULL,
  `facAmount` int(11) DEFAULT NULL,
  KEY `fk_housefac_fac` (`facId`),
  KEY `fk_housefac_house` (`houseId`),
  CONSTRAINT `fk_housefac_fac` FOREIGN KEY (`facId`) REFERENCES `r_fac` (`facId`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_housefac_house` FOREIGN KEY (`houseId`) REFERENCES `r_house` (`houseId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_housefac
-- ----------------------------
INSERT INTO `r_housefac` VALUES ('101', '3', '1');
INSERT INTO `r_housefac` VALUES ('101', '2', '2');
INSERT INTO `r_housefac` VALUES ('101', '1', '2');
INSERT INTO `r_housefac` VALUES ('101', '5', '1');
INSERT INTO `r_housefac` VALUES ('101', '6', '1');
INSERT INTO `r_housefac` VALUES ('101', '7', '1');
INSERT INTO `r_housefac` VALUES ('101', '9', '1');
INSERT INTO `r_housefac` VALUES ('101', '12', '1');
INSERT INTO `r_housefac` VALUES ('101', '13', '1');
INSERT INTO `r_housefac` VALUES ('101', '14', '1');
INSERT INTO `r_housefac` VALUES ('101', '16', '1');
INSERT INTO `r_housefac` VALUES ('101', '17', '1');
INSERT INTO `r_housefac` VALUES ('101', '18', '1');
INSERT INTO `r_housefac` VALUES ('101', '19', '1');
INSERT INTO `r_housefac` VALUES ('102', '3', '1');
INSERT INTO `r_housefac` VALUES ('102', '2', '1');
INSERT INTO `r_housefac` VALUES ('102', '1', '1');
INSERT INTO `r_housefac` VALUES ('102', '4', '1');
INSERT INTO `r_housefac` VALUES ('102', '12', '1');
INSERT INTO `r_housefac` VALUES ('102', '15', '1');
INSERT INTO `r_housefac` VALUES ('103', '3', '1');
INSERT INTO `r_housefac` VALUES ('103', '2', '1');
INSERT INTO `r_housefac` VALUES ('103', '1', '1');
INSERT INTO `r_housefac` VALUES ('103', '5', '1');
INSERT INTO `r_housefac` VALUES ('103', '6', '1');
INSERT INTO `r_housefac` VALUES ('103', '7', '1');
INSERT INTO `r_housefac` VALUES ('103', '12', '1');
INSERT INTO `r_housefac` VALUES ('103', '13', '1');
INSERT INTO `r_housefac` VALUES ('103', '14', '1');
INSERT INTO `r_housefac` VALUES ('103', '17', '1');
INSERT INTO `r_housefac` VALUES ('103', '18', '1');
INSERT INTO `r_housefac` VALUES ('103', '19', '1');
INSERT INTO `r_housefac` VALUES ('103', '20', '1');
INSERT INTO `r_housefac` VALUES ('104', '3', '3');
INSERT INTO `r_housefac` VALUES ('104', '2', '3');
INSERT INTO `r_housefac` VALUES ('104', '1', '3');
INSERT INTO `r_housefac` VALUES ('104', '5', '1');
INSERT INTO `r_housefac` VALUES ('104', '7', '1');
INSERT INTO `r_housefac` VALUES ('104', '9', '1');
INSERT INTO `r_housefac` VALUES ('104', '12', '1');
INSERT INTO `r_housefac` VALUES ('104', '14', '1');
INSERT INTO `r_housefac` VALUES ('104', '15', '1');
INSERT INTO `r_housefac` VALUES ('104', '16', '1');
INSERT INTO `r_housefac` VALUES ('105', '3', '1');
INSERT INTO `r_housefac` VALUES ('105', '1', '5');
INSERT INTO `r_housefac` VALUES ('105', '4', '1');
INSERT INTO `r_housefac` VALUES ('105', '5', '1');
INSERT INTO `r_housefac` VALUES ('105', '6', '1');
INSERT INTO `r_housefac` VALUES ('105', '7', '1');
INSERT INTO `r_housefac` VALUES ('105', '8', '1');
INSERT INTO `r_housefac` VALUES ('105', '9', '1');
INSERT INTO `r_housefac` VALUES ('105', '10', '1');
INSERT INTO `r_housefac` VALUES ('105', '11', '1');
INSERT INTO `r_housefac` VALUES ('105', '12', '1');
INSERT INTO `r_housefac` VALUES ('105', '13', '1');
INSERT INTO `r_housefac` VALUES ('105', '14', '1');
INSERT INTO `r_housefac` VALUES ('105', '15', '1');
INSERT INTO `r_housefac` VALUES ('105', '16', '1');
INSERT INTO `r_housefac` VALUES ('105', '17', '1');
INSERT INTO `r_housefac` VALUES ('105', '18', '1');
INSERT INTO `r_housefac` VALUES ('105', '19', '1');
INSERT INTO `r_housefac` VALUES ('105', '20', '1');
INSERT INTO `r_housefac` VALUES ('106', '3', '1');
INSERT INTO `r_housefac` VALUES ('106', '2', '1');
INSERT INTO `r_housefac` VALUES ('106', '4', '1');
INSERT INTO `r_housefac` VALUES ('106', '12', '1');
INSERT INTO `r_housefac` VALUES ('106', '15', '1');
INSERT INTO `r_housefac` VALUES ('107', '3', '2');
INSERT INTO `r_housefac` VALUES ('107', '2', '1');
INSERT INTO `r_housefac` VALUES ('107', '1', '1');
INSERT INTO `r_housefac` VALUES ('107', '5', '1');
INSERT INTO `r_housefac` VALUES ('107', '6', '1');
INSERT INTO `r_housefac` VALUES ('107', '7', '1');
INSERT INTO `r_housefac` VALUES ('107', '8', '1');
INSERT INTO `r_housefac` VALUES ('107', '9', '1');
INSERT INTO `r_housefac` VALUES ('107', '10', '1');
INSERT INTO `r_housefac` VALUES ('107', '11', '1');
INSERT INTO `r_housefac` VALUES ('107', '12', '1');
INSERT INTO `r_housefac` VALUES ('107', '13', '1');
INSERT INTO `r_housefac` VALUES ('107', '14', '1');
INSERT INTO `r_housefac` VALUES ('107', '15', '1');
INSERT INTO `r_housefac` VALUES ('107', '16', '1');
INSERT INTO `r_housefac` VALUES ('107', '17', '1');
INSERT INTO `r_housefac` VALUES ('107', '18', '1');
INSERT INTO `r_housefac` VALUES ('107', '19', '1');
INSERT INTO `r_housefac` VALUES ('107', '20', '1');
INSERT INTO `r_housefac` VALUES ('108', '3', '1');
INSERT INTO `r_housefac` VALUES ('108', '2', '1');
INSERT INTO `r_housefac` VALUES ('108', '4', '1');
INSERT INTO `r_housefac` VALUES ('108', '12', '1');
INSERT INTO `r_housefac` VALUES ('108', '15', '1');
INSERT INTO `r_housefac` VALUES ('109', '3', '1');
INSERT INTO `r_housefac` VALUES ('109', '2', '1');
INSERT INTO `r_housefac` VALUES ('109', '4', '1');
INSERT INTO `r_housefac` VALUES ('109', '12', '1');
INSERT INTO `r_housefac` VALUES ('109', '15', '1');
INSERT INTO `r_housefac` VALUES ('110', '3', '1');
INSERT INTO `r_housefac` VALUES ('110', '2', '1');
INSERT INTO `r_housefac` VALUES ('110', '4', '1');
INSERT INTO `r_housefac` VALUES ('110', '12', '1');
INSERT INTO `r_housefac` VALUES ('110', '15', '1');
INSERT INTO `r_housefac` VALUES ('111', '3', '1');
INSERT INTO `r_housefac` VALUES ('111', '2', '1');
INSERT INTO `r_housefac` VALUES ('111', '4', '1');
INSERT INTO `r_housefac` VALUES ('111', '12', '1');
INSERT INTO `r_housefac` VALUES ('111', '15', '1');
INSERT INTO `r_housefac` VALUES ('112', '3', '1');
INSERT INTO `r_housefac` VALUES ('112', '2', '1');
INSERT INTO `r_housefac` VALUES ('112', '4', '1');
INSERT INTO `r_housefac` VALUES ('112', '12', '1');
INSERT INTO `r_housefac` VALUES ('112', '15', '1');
INSERT INTO `r_housefac` VALUES ('113', '3', '1');
INSERT INTO `r_housefac` VALUES ('113', '2', '1');
INSERT INTO `r_housefac` VALUES ('114', '3', '1');
INSERT INTO `r_housefac` VALUES ('114', '2', '1');
INSERT INTO `r_housefac` VALUES ('114', '4', '1');
INSERT INTO `r_housefac` VALUES ('114', '12', '1');
INSERT INTO `r_housefac` VALUES ('114', '15', '1');
INSERT INTO `r_housefac` VALUES ('115', '3', '4');
INSERT INTO `r_housefac` VALUES ('115', '2', '2');
INSERT INTO `r_housefac` VALUES ('115', '1', '2');
INSERT INTO `r_housefac` VALUES ('115', '6', '1');
INSERT INTO `r_housefac` VALUES ('115', '7', '1');
INSERT INTO `r_housefac` VALUES ('115', '8', '1');
INSERT INTO `r_housefac` VALUES ('115', '9', '1');
INSERT INTO `r_housefac` VALUES ('115', '10', '1');
INSERT INTO `r_housefac` VALUES ('115', '11', '1');
INSERT INTO `r_housefac` VALUES ('115', '12', '1');
INSERT INTO `r_housefac` VALUES ('115', '13', '1');
INSERT INTO `r_housefac` VALUES ('115', '14', '1');
INSERT INTO `r_housefac` VALUES ('115', '16', '1');
INSERT INTO `r_housefac` VALUES ('115', '18', '1');
INSERT INTO `r_housefac` VALUES ('116', '3', '1');
INSERT INTO `r_housefac` VALUES ('116', '2', '1');
INSERT INTO `r_housefac` VALUES ('116', '4', '1');
INSERT INTO `r_housefac` VALUES ('116', '12', '1');
INSERT INTO `r_housefac` VALUES ('116', '15', '1');
INSERT INTO `r_housefac` VALUES ('117', '3', '2');
INSERT INTO `r_housefac` VALUES ('117', '2', '3');
INSERT INTO `r_housefac` VALUES ('117', '1', '2');
INSERT INTO `r_housefac` VALUES ('117', '4', '1');
INSERT INTO `r_housefac` VALUES ('117', '5', '1');
INSERT INTO `r_housefac` VALUES ('117', '6', '1');
INSERT INTO `r_housefac` VALUES ('117', '7', '1');
INSERT INTO `r_housefac` VALUES ('117', '8', '1');
INSERT INTO `r_housefac` VALUES ('117', '9', '1');
INSERT INTO `r_housefac` VALUES ('117', '10', '1');
INSERT INTO `r_housefac` VALUES ('117', '11', '1');
INSERT INTO `r_housefac` VALUES ('117', '12', '1');
INSERT INTO `r_housefac` VALUES ('117', '13', '1');
INSERT INTO `r_housefac` VALUES ('117', '14', '1');
INSERT INTO `r_housefac` VALUES ('117', '15', '1');
INSERT INTO `r_housefac` VALUES ('117', '16', '1');
INSERT INTO `r_housefac` VALUES ('117', '17', '1');
INSERT INTO `r_housefac` VALUES ('117', '18', '1');
INSERT INTO `r_housefac` VALUES ('117', '19', '1');
INSERT INTO `r_housefac` VALUES ('117', '20', '1');
INSERT INTO `r_housefac` VALUES ('118', '3', '1');
INSERT INTO `r_housefac` VALUES ('118', '2', '1');
INSERT INTO `r_housefac` VALUES ('118', '4', '1');
INSERT INTO `r_housefac` VALUES ('118', '12', '1');
INSERT INTO `r_housefac` VALUES ('118', '15', '1');
INSERT INTO `r_housefac` VALUES ('119', '3', '1');
INSERT INTO `r_housefac` VALUES ('119', '2', '1');
INSERT INTO `r_housefac` VALUES ('120', '3', '2');
INSERT INTO `r_housefac` VALUES ('120', '2', '2');
INSERT INTO `r_housefac` VALUES ('120', '1', '1');
INSERT INTO `r_housefac` VALUES ('120', '5', '1');
INSERT INTO `r_housefac` VALUES ('120', '6', '1');
INSERT INTO `r_housefac` VALUES ('120', '8', '1');
INSERT INTO `r_housefac` VALUES ('120', '9', '1');
INSERT INTO `r_housefac` VALUES ('120', '10', '1');
INSERT INTO `r_housefac` VALUES ('120', '12', '1');
INSERT INTO `r_housefac` VALUES ('120', '13', '1');
INSERT INTO `r_housefac` VALUES ('120', '14', '1');
INSERT INTO `r_housefac` VALUES ('120', '15', '1');
INSERT INTO `r_housefac` VALUES ('120', '16', '1');
INSERT INTO `r_housefac` VALUES ('120', '17', '1');
INSERT INTO `r_housefac` VALUES ('120', '18', '1');
INSERT INTO `r_housefac` VALUES ('120', '19', '1');
INSERT INTO `r_housefac` VALUES ('120', '20', '1');
INSERT INTO `r_housefac` VALUES ('121', '3', '1');
INSERT INTO `r_housefac` VALUES ('121', '2', '1');
INSERT INTO `r_housefac` VALUES ('122', '3', '1');
INSERT INTO `r_housefac` VALUES ('122', '2', '1');
INSERT INTO `r_housefac` VALUES ('122', '4', '1');
INSERT INTO `r_housefac` VALUES ('122', '15', '1');
INSERT INTO `r_housefac` VALUES ('123', '3', '2');
INSERT INTO `r_housefac` VALUES ('123', '2', '1');
INSERT INTO `r_housefac` VALUES ('123', '1', '1');
INSERT INTO `r_housefac` VALUES ('123', '6', '1');
INSERT INTO `r_housefac` VALUES ('123', '8', '1');
INSERT INTO `r_housefac` VALUES ('123', '9', '1');
INSERT INTO `r_housefac` VALUES ('123', '10', '1');
INSERT INTO `r_housefac` VALUES ('123', '12', '1');
INSERT INTO `r_housefac` VALUES ('123', '14', '1');
INSERT INTO `r_housefac` VALUES ('123', '16', '1');
INSERT INTO `r_housefac` VALUES ('123', '17', '1');
INSERT INTO `r_housefac` VALUES ('123', '19', '1');
INSERT INTO `r_housefac` VALUES ('124', '3', '1');
INSERT INTO `r_housefac` VALUES ('124', '2', '1');
INSERT INTO `r_housefac` VALUES ('124', '4', '1');
INSERT INTO `r_housefac` VALUES ('124', '12', '1');
INSERT INTO `r_housefac` VALUES ('124', '15', '1');
INSERT INTO `r_housefac` VALUES ('125', '3', '2');
INSERT INTO `r_housefac` VALUES ('125', '2', '2');
INSERT INTO `r_housefac` VALUES ('125', '1', '1');
INSERT INTO `r_housefac` VALUES ('125', '5', '1');
INSERT INTO `r_housefac` VALUES ('125', '6', '1');
INSERT INTO `r_housefac` VALUES ('125', '7', '1');
INSERT INTO `r_housefac` VALUES ('125', '9', '1');
INSERT INTO `r_housefac` VALUES ('125', '12', '1');
INSERT INTO `r_housefac` VALUES ('125', '14', '1');
INSERT INTO `r_housefac` VALUES ('125', '15', '1');
INSERT INTO `r_housefac` VALUES ('125', '16', '1');
INSERT INTO `r_housefac` VALUES ('125', '17', '1');
INSERT INTO `r_housefac` VALUES ('125', '18', '1');
INSERT INTO `r_housefac` VALUES ('126', '3', '1');
INSERT INTO `r_housefac` VALUES ('126', '2', '1');
INSERT INTO `r_housefac` VALUES ('127', '3', '3');
INSERT INTO `r_housefac` VALUES ('127', '2', '2');
INSERT INTO `r_housefac` VALUES ('127', '1', '2');
INSERT INTO `r_housefac` VALUES ('127', '4', '1');
INSERT INTO `r_housefac` VALUES ('127', '7', '1');
INSERT INTO `r_housefac` VALUES ('127', '9', '1');
INSERT INTO `r_housefac` VALUES ('127', '12', '1');
INSERT INTO `r_housefac` VALUES ('127', '14', '1');
INSERT INTO `r_housefac` VALUES ('127', '15', '1');
INSERT INTO `r_housefac` VALUES ('127', '16', '1');
INSERT INTO `r_housefac` VALUES ('127', '17', '1');
INSERT INTO `r_housefac` VALUES ('127', '18', '1');
INSERT INTO `r_housefac` VALUES ('128', '3', '1');
INSERT INTO `r_housefac` VALUES ('128', '2', '1');
INSERT INTO `r_housefac` VALUES ('128', '4', '1');
INSERT INTO `r_housefac` VALUES ('128', '12', '1');
INSERT INTO `r_housefac` VALUES ('128', '15', '1');
INSERT INTO `r_housefac` VALUES ('129', '3', '1');
INSERT INTO `r_housefac` VALUES ('129', '2', '1');
INSERT INTO `r_housefac` VALUES ('129', '4', '1');
INSERT INTO `r_housefac` VALUES ('129', '12', '1');
INSERT INTO `r_housefac` VALUES ('129', '15', '1');
INSERT INTO `r_housefac` VALUES ('130', '3', '1');
INSERT INTO `r_housefac` VALUES ('130', '2', '1');
INSERT INTO `r_housefac` VALUES ('131', '3', '1');
INSERT INTO `r_housefac` VALUES ('131', '2', '1');
INSERT INTO `r_housefac` VALUES ('131', '15', '1');
INSERT INTO `r_housefac` VALUES ('132', '3', '1');
INSERT INTO `r_housefac` VALUES ('132', '2', '1');
INSERT INTO `r_housefac` VALUES ('132', '15', '1');
INSERT INTO `r_housefac` VALUES ('133', '3', '1');
INSERT INTO `r_housefac` VALUES ('133', '1', '2');
INSERT INTO `r_housefac` VALUES ('133', '4', '1');
INSERT INTO `r_housefac` VALUES ('133', '5', '1');
INSERT INTO `r_housefac` VALUES ('133', '6', '1');
INSERT INTO `r_housefac` VALUES ('133', '12', '1');
INSERT INTO `r_housefac` VALUES ('133', '13', '1');
INSERT INTO `r_housefac` VALUES ('133', '14', '1');
INSERT INTO `r_housefac` VALUES ('133', '16', '1');
INSERT INTO `r_housefac` VALUES ('133', '17', '1');
INSERT INTO `r_housefac` VALUES ('133', '18', '1');
INSERT INTO `r_housefac` VALUES ('134', '3', '1');
INSERT INTO `r_housefac` VALUES ('134', '2', '1');
INSERT INTO `r_housefac` VALUES ('135', '3', '1');
INSERT INTO `r_housefac` VALUES ('135', '2', '1');
INSERT INTO `r_housefac` VALUES ('135', '4', '1');
INSERT INTO `r_housefac` VALUES ('135', '12', '1');
INSERT INTO `r_housefac` VALUES ('135', '15', '1');
INSERT INTO `r_housefac` VALUES ('136', '3', '1');
INSERT INTO `r_housefac` VALUES ('136', '1', '1');
INSERT INTO `r_housefac` VALUES ('136', '4', '1');
INSERT INTO `r_housefac` VALUES ('136', '12', '1');
INSERT INTO `r_housefac` VALUES ('136', '19', '1');
INSERT INTO `r_housefac` VALUES ('137', '3', '1');
INSERT INTO `r_housefac` VALUES ('137', '1', '1');
INSERT INTO `r_housefac` VALUES ('137', '4', '1');
INSERT INTO `r_housefac` VALUES ('137', '12', '1');
INSERT INTO `r_housefac` VALUES ('137', '15', '1');

-- ----------------------------
-- Table structure for `r_housestatus`
-- ----------------------------
DROP TABLE IF EXISTS `r_housestatus`;
CREATE TABLE `r_housestatus` (
  `houseStatusId` int(11) NOT NULL AUTO_INCREMENT,
  `houseStatusName` varchar(20) NOT NULL,
  PRIMARY KEY (`houseStatusId`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_housestatus
-- ----------------------------
INSERT INTO `r_housestatus` VALUES ('1', '正常');
INSERT INTO `r_housestatus` VALUES ('2', '举报');
INSERT INTO `r_housestatus` VALUES ('3', '撤销');
INSERT INTO `r_housestatus` VALUES ('4', '信息待完善');
INSERT INTO `r_housestatus` VALUES ('5', '暂时关闭');

-- ----------------------------
-- Table structure for `r_housetype`
-- ----------------------------
DROP TABLE IF EXISTS `r_housetype`;
CREATE TABLE `r_housetype` (
...
-- ----------------------------
-- Records of r_housetype
-- ----------------------------
INSERT INTO `r_housetype` VALUES ('1', '公寓型住宅');
INSERT INTO `r_housetype` VALUES ('2', '独栋房');
INSERT INTO `r_housetype` VALUES ('3', '别墅');
INSERT INTO `r_housetype` VALUES ('4', 'Loft');
INSERT INTO `r_housetype` VALUES ('5', '酒店');
INSERT INTO `r_housetype` VALUES ('6', '酒店式公寓');
INSERT INTO `r_housetype` VALUES ('7', '精品酒店');
INSERT INTO `r_housetype` VALUES ('8', '青年旅社');
INSERT INTO `r_housetype` VALUES ('9', '农家乐');
INSERT INTO `r_housetype` VALUES ('10', '度假村');
INSERT INTO `r_housetype` VALUES ('11', '乡村小屋');
INSERT INTO `r_housetype` VALUES ('12', '蒙古包');
...
CREATE TABLE `r_order` (
  ...
  `servFee` double NOT NULL,
  `price` double NOT NULL,
  `orderStatusId` int(11) NOT NULL,
  `orderDate` varchar(50) NOT NULL,
  `guestNum` int(11) NOT NULL,
  PRIMARY KEY (`orderId`),
  KEY `fk_order_guest_user` (`guestId`),
  KEY `fk_order_owner_user` (`ownerId`),
  KEY `fk_order_orderStatus` (`orderStatusId`),
  KEY `fk_order_house` (`houseId`),
  CONSTRAINT `fk_order_guest_user` FOREIGN KEY (`guestId`) REFERENCES `r_user` (`userId`),
  CONSTRAINT `fk_order_house` FOREIGN KEY (`houseId`) REFERENCES `r_house` (`houseId`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_order_orderStatus` FOREIGN KEY (`orderStatusId`) REFERENCES `r_orderstatus` (`orderStatusId`),
  CONSTRAINT `fk_order_owner_user` FOREIGN KEY (`ownerId`) REFERENCES `r_user` (`userId`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_order
-- ----------------------------
INSERT INTO `r_order` VALUES ('29', '102', '26', '26', '2019-7-31', '2019-08-09', '20', '100', '4', '2019年7月31日17:30:58', '2');
INSERT INTO `r_order` VALUES ('30', '101', '27', '27', '2019-7-31', '2019-08-02', '60', '300', '1', '2019年7月31日17:30:54', '1');
INSERT INTO `r_order` VALUES ('31', '102', '28', '26', '2019-7-31', '2019-08-09', '20', '100', '4', '2019年7月31日18:6:53', '3');
INSERT INTO `r_order` VALUES ('32', '101', '28', '27', '2019-7-31', '2019-08-02', '60', '300', '4', '2019年7月31日18:22:7', '3');
INSERT INTO `r_order` VALUES ('33', '102', '26', '26', '2019-7-31', '2019-08-09', '20', '100', '2', '2019年7月31日18:28:19', '3');
INSERT INTO `r_order` VALUES ('34', '101', '27', '30', '2019-6-25', '2019-6-26', '36', '180', '2', '2019年6月20日19:06:50', '2');
INSERT INTO `r_order` VALUES ('35', '103', '30', '31', '2019-5-25', '2019-5-26', '36', '180', '4', '2019年5月20日19:06:50', '1');
INSERT INTO `r_order` VALUES ('36', '101', '26', '27', '2019-08-02', '2019-08-03', '60', '300', '2', '2019年7月31日19:32:24', '3');
INSERT INTO `r_order` VALUES ('37', '106', '28', '26', '2019-08-03', '2019-08-10', '40', '200', '4', '2019年8月1日8:32:29', '3');
INSERT INTO `r_order` VALUES ('38', '101', '45', '27', '2019-08-03', '2019-08-05', '60', '300', '4', '2019年8月1日8:43:22', '3');
INSERT INTO `r_order` VALUES ('39', '103', '27', '27', '2019-8-1', '2019-8-2', '67.8', '339', '1', '2019年8月1日8:44:22', '1');
INSERT INTO `r_order` VALUES ('40', '106', '49', '26', '2019-8-1', '2019-8-2', '40', '200', '1', '2019年8月1日10:45:58', '1');
INSERT INTO `r_order` VALUES ('41', '102', '26', '26', '2019-8-1', '2019-8-2', '20', '100', '1', '2019年8月1日11:2:26', '1');
INSERT INTO `r_order` VALUES ('42', '109', '28', '26', '2019-08-08', '2019-08-14', '60', '300', '2', '2019年8月1日11:2:38', '2');

-- ----------------------------
-- Table structure for `r_orderstatus`
-- ----------------------------
DROP TABLE IF EXISTS `r_orderstatus`;
CREATE TABLE `r_orderstatus` (
...
-- ----------------------------
-- Records of r_orderstatus
-- ----------------------------
INSERT INTO `r_orderstatus` VALUES ('1', '预订未支付');
INSERT INTO `r_orderstatus` VALUES ('2', '交易进行中');
INSERT INTO `r_orderstatus` VALUES ('3', '交易关闭');
INSERT INTO `r_orderstatus` VALUES ('4', '交易完成');
INSERT INTO `r_orderstatus` VALUES ('6', '退款成功');
...
CREATE TABLE `r_report` (
  ...
  `reportTime` varchar(100) NOT NULL,
  PRIMARY KEY (`reportId`),
  KEY `fk_report_user` (`userId`),
  KEY `fk_report_house` (`houseId`),
  CONSTRAINT `fk_report_house` FOREIGN KEY (`houseId`) REFERENCES `r_house` (`houseId`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_report_user` FOREIGN KEY (`userId`) REFERENCES `r_user` (`userId`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_report
-- ----------------------------
INSERT INTO `r_report` VALUES ('1', '103', '26', '天天学习', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('2', '103', '26', '死不悔改', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('3', '102', '28', '尬舞噶', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('4', '103', '28', '社会卡卡', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('5', '103', '28', '喊饿合同', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('6', '103', '28', '萨拉给你', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('7', '102', '28', '阿尔哈尔', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('8', '103', '28', '萨哈俄国和', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('9', '104', '28', '阿嘎嘎嘎', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('10', '103', '27', '啊哈恶化', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('11', '103', '31', '收到任何锦上添花', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('12', '119', '26', '阿尔尬舞', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('13', '105', '28', '按国家按高考', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('14', '111', '44', '阿嘎问问题高', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('15', '103', '28', '爱国瓦工', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('16', '109', '31', '请按噶切割', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('17', '111', '31', '哇嘎我国', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('18', '104', '28', '阿尔高哈尔个人', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('19', '104', '44', '阿尔高', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('20', '110', '44', '其貌不扬', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('21', '111', '44', '阿尔高让我咬人', '0', '2019年7月24日13:39:53');
INSERT INTO `r_report` VALUES ('22', '101', '26', 'jubao', '0', '2019年08月01日 10:53:34');

-- ----------------------------
-- Table structure for `r_rule`
-- ----------------------------
DROP TABLE IF EXISTS `r_rule`;
CREATE TABLE `r_rule` (
  `servFee` double NOT NULL,
  `cancelPercent` double NOT NULL,
...
-- Records of r_rule
-- ----------------------------
INSERT INTO `r_rule` VALUES ('20', '10', '1');

-- ----------------------------
-- Table structure for `r_story`
-- ----------------------------
DROP TABLE IF EXISTS `r_story`;
CREATE TABLE `r_story` (
  `storyId` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
  `storyTitle` varchar(50) NOT NULL,
  `storyText` text NOT NULL,
  `storyHeat` int(11) DEFAULT NULL,
  `storyTime` varchar(100) NOT NULL,
  `orderId` int(11) NOT NULL,
  `storyImg` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`storyId`),
  KEY `fk_story_user` (`userId`),
  KEY `fk_story_order` (`orderId`),
  CONSTRAINT `fk_story_order` FOREIGN KEY (`orderId`) REFERENCES `r_order` (`orderId`),
  CONSTRAINT `fk_story_user` FOREIGN KEY (`userId`) REFERENCES `r_user` (`userId`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_story
-- ----------------------------
INSERT INTO `r_story` VALUES ('17', '28', '清迈探店 | 慵懒的小城慵懒的下午茶', '<p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; font-variant-numeric: normal; font-variant-east-asian: normal; white-space: normal; widows: 1; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">快闪店名称：马当路LUONE B2室内下沉广场</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; font-variant-numeric: normal; font-variant-east-asian: normal; white-space: normal; widows: 1; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">快闪店时间：2019/1/18- 2019/2/28</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; font-variant-numeric: normal; font-variant-east-asian: normal; white-space: normal; widows: 1; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">作为国民零食元老的代表，大白兔奶糖在每个人的心中都有属于自己的甜蜜记忆。转眼间这个品牌已经60周年，也算是一只历经岁月风霜的老兔子了~。虽然说怀揣着一口袋奶糖去上课的日子已经离我很远很远，但是一想到这些光阴片段，我的心儿都开始变得软绵绵 。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; font-variant-numeric: normal; font-variant-east-asian: normal; white-space: normal; widows: 1; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">此次大白兔在LuOne 开设的快闪店非常吸引眼球。 还未进商场就已经被商场门口的巨大白兔所吸引。 快闪展览中有不少的互动环节，可以抓娃娃机，玩小游戏，拍美美照片。‍♀️最讨喜的还是贩售的大白兔周边，你别说把大白兔做成润唇膏的样子还真的超可爱der！ 60岁的大白兔到现在看起来都还是软萌又有趣。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; font-variant-numeric: normal; font-variant-east-asian: normal; white-space: normal; widows: 1; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">今后的约会还送巧克力吗？不如换成大白兔吧。 把小时候的甜蜜回忆分享给爱的人，只需要从一颗奶糖开始。</p><p><br/></p>', '3', '2019年07月31日', '32', '/c51b72f2d_1564572526994.jpg');
INSERT INTO `r_story` VALUES ('18', '28', '又是临安细雨时', '<p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; font-variant-numeric: normal; font-variant-east-asian: normal; white-space: normal; widows: 1; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">东极岛是对东极镇所管辖的列岛统称，外部来的船渡都会先到达庙子湖，去往其他岛屿则需要换乘其他船只。船渡一天只有四班，所以即使赶上了十一黄金周，岛上依旧人烟稀少的感觉，简直是黄金周避免被游人淹没的好地方。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; font-variant-numeric: normal; font-variant-east-asian: normal; white-space: normal; widows: 1; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">环岛庙子湖我有两条路线，一是徒步，二是摆渡车。从码头出来一直向北，沿着庙子湖最西边的道路一路上山，坡度不是很大，这条线的关键在于人少，徒步三小时没遇到五个人，而且风景极美。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; font-variant-numeric: normal; font-variant-east-asian: normal; white-space: normal; widows: 1; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">虽然东极因《后会无期》知名，不过眼前的东极远比电影中更美，岛上安静闲适，耳边只有海浪拍打礁石、风吹麦草的声音，海风虽然将头发吹得乱七八糟，但风拂过脸颊的感觉真的很爽，满岛苍翠的芒草让人感觉舒服，而且越往上走看到的大海越是广袤，阴天带来微微的雾模糊了大海和天空，几乎看不到二者的分界，好像天地间空无一物，只剩下小岛。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; font-variant-numeric: normal; font-variant-east-asian: normal; white-space: normal; widows: 1; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">在码头就可以乘坐摆渡车，一览岛上所有知名地方，开车的大叔会一路介绍岛上的趣事，这条线路的坡度也变得很大，大叔笑说我得把1.3排量开出3.3的速度（才能上这些坡）。经过观光点都是可以下车的，沿路可以看到“六角齐飞”的美丽亭子，路经中国最东边部队的驻扎基地，纪念岛上第一人而设的巨大雕塑，《后会无期》中出现的那个小房子，还有要像山羊一样走山才能看到的红白灯塔。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; font-variant-numeric: normal; font-variant-east-asian: normal; white-space: normal; widows: 1; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">虽然去东极岛的路程远比做计划时想象的远，从北京出发先是到了宁波站，从宁波坐近3小时大巴到达沈家门，第二天8点赶上第一班前往东极的班船，赶上涨潮，风浪大到整个船的乘客都在晕船，原本以为是悲惨的开始，但最后发现一切都是值得的。</p>', '2', '2019年07月31日', '32', '/637_1564573681822.jpg');
INSERT INTO `r_story` VALUES ('19', '28', '清迈探店 | 慵懒的小城慵懒的下午茶', '<p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">圆明园长春园，花期7月-8月。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">帝都夏天赏荷的地方不少，本着有园就必有水的造景理念。能泛舟赏荷花的也有北海和紫竹院两处。但论面积和气势，都不能和圆明园三园的磅礴水系相比。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">现存的圆明园遗址公园本是由圆明园，长春园和绮春园三园组成，因此又称圆明三园。现存的长春园，因是三园里最有野趣的一处。法慧寺旁边本有一楼阁，四个字最能描述这种波澜万千的气象，称为海岳开襟。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">在此处建议坐游船赏荷路线。也可由圆明园东门进入，在狮子林近距离观赏荷花。此处有部分遗址，目前恢复虹桥，水关，水门三座石桥。另有乾隆诗刻32件复位保护。长春园的荷花为次第开放，因此总有新的花苞和已经开败的莲蓬呼应。到彩虹桥一带也是荷花最密集的地区。</p><p><br/></p>', '1', '2019年08月01日', '32', '/storyImg/9_1564624995954.jpg');
INSERT INTO `r_story` VALUES ('20', '28', '清迈探店 | 慵懒的小城慵懒的下午茶', '<p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">圆明园长春园，花期7月-8月。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">帝都夏天赏荷的地方不少，本着有园就必有水的造景理念。能泛舟赏荷花的也有北海和紫竹院两处。但论面积和气势，都不能和圆明园三园的磅礴水系相比。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">现存的圆明园遗址公园本是由圆明园，长春园和绮春园三园组成，因此又称圆明三园。现存的长春园，因是三园里最有野趣的一处。法慧寺旁边本有一楼阁，四个字最能描述这种波澜万千的气象，称为海岳开襟。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">在此处建议坐游船赏荷路线。也可由圆明园东门进入，在狮子林近距离观赏荷花。此处有部分遗址，目前恢复虹桥，水关，水门三座石桥。另有乾隆诗刻32件复位保护。长春园的荷花为次第开放，因此总有新的花苞和已经开败的莲蓬呼应。到彩虹桥一带也是荷花最密集的地区。</p><p><br/></p>', '1', '2019年08月01日', '32', '/storyImg/637_1564627613870.jpg');
INSERT INTO `r_story` VALUES ('21', '28', '突然闪现的大白兔快闪店～', '', '0', '2019年08月01日', '32', '/storyImg/c51b72f2d_1564630710855.jpg');
INSERT INTO `r_story` VALUES ('22', '28', '左手遗址文明，右手现代艺术，我在良渚寻访江南源头', '<p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">圆明园长春园，花期7月-8月。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">帝都夏天赏荷的地方不少，本着有园就必有水的造景理念。能泛舟赏荷花的也有北海和紫竹院两处。但论面积和气势，都不能和圆明园三园的磅礴水系相比。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">现存的圆明园遗址公园本是由圆明园，长春园和绮春园三园组成，因此又称圆明三园。现存的长春园，因是三园里最有野趣的一处。法慧寺旁边本有一楼阁，四个字最能描述这种波澜万千的气象，称为海岳开襟。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">在此处建议坐游船赏荷路线。也可由圆明园东门进入，在狮子林近距离观赏荷花。此处有部分遗址，目前恢复虹桥，水关，水门三座石桥。另有乾隆诗刻32件复位保护。长春园的荷花为次第开放，因此总有新的花苞和已经开败的莲蓬呼应。到彩虹桥一带也是荷花最密集的地区。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">圆明园长春园，花期7月-8月。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">帝都夏天赏荷的地方不少，本着有园就必有水的造景理念。能泛舟赏荷花的也有北海和紫竹院两处。但论面积和气势，都不能和圆明园三园的磅礴水系相比。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">现存的圆明园遗址公园本是由圆明园，长春园和绮春园三园组成，因此又称圆明三园。现存的长春园，因是三园里最有野趣的一处。法慧寺旁边本有一楼阁，四个字最能描述这种波澜万千的气象，称为海岳开襟。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">在此处建议坐游船赏荷路线。也可由圆明园东门进入，在狮子林近距离观赏荷花。此处有部分遗址，目前恢复虹桥，水关，水门三座石桥。另有乾隆诗刻32件复位保护。长春园的荷花为次第开放，因此总有新的花苞和已经开败的莲蓬呼应。到彩虹桥一带也是荷花最密集的地区。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">圆明园长春园，花期7月-8月。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">帝都夏天赏荷的地方不少，本着有园就必有水的造景理念。能泛舟赏荷花的也有北海和紫竹院两处。但论面积和气势，都不能和圆明园三园的磅礴水系相比。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">现存的圆明园遗址公园本是由圆明园，长春园和绮春园三园组成，因此又称圆明三园。现存的长春园，因是三园里最有野趣的一处。法慧寺旁边本有一楼阁，四个字最能描述这种波澜万千的气象，称为海岳开襟。</p><p class=\"_9j5k16\" style=\"box-sizing: border-box; font-family: Circular, PingFang-SC, &quot;Hiragino Sans GB&quot;, 微软雅黑, &quot;Microsoft YaHei&quot;, &quot;Heiti SC&quot;; white-space: normal; background-color: rgb(255, 255, 255); margin-top: 1.7em !important; margin-bottom: 1.7em !important; font-size: 19px !important; line-height: 1.7em !important; color: rgb(86, 90, 92) !important;\">在此处建议坐游船赏荷路线。也可由圆明园东门进入，在狮子林近距离观赏荷花。此处有部分遗址，目前恢复虹桥，水关，水门三座石桥。另有乾隆诗刻32件复位保护。长春园的荷花为次第开放，因此总有新的花苞和已经开败的莲蓬呼应。到彩虹桥一带也是荷花最密集的地区。</p><p><br/></p>', '0', '2019年08月01日', '32', '/storyImg/56f75208767a0783e4f4ad8833f33e5d_1564631667449.jpg');
INSERT INTO `r_story` VALUES ('23', '28', '111', '<p>222</p>', '1', '2019年08月01日', '31', '/storyImg/2_1564632179226.jpg');
INSERT INTO `r_story` VALUES ('24', '26', '11', '<p>11<br/></p>', '0', '2019年08月01日', '29', '/storyImg/QQ图片20190618133920_1564632184053.jpg');

-- ----------------------------
-- Table structure for `r_storycomt`
-- ----------------------------
DROP TABLE IF EXISTS `r_storycomt`;
CREATE TABLE `r_storycomt` (
  `sComtId` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) NOT NULL,
  `storyId` int(11) NOT NULL,
  `storyComtText` text NOT NULL,
  `storyComtTime` varchar(50) NOT NULL,
  PRIMARY KEY (`sComtId`),
  KEY `fk_storyComt_user` (`userId`),
  KEY `fk_storyComt_story` (`storyId`),
  CONSTRAINT `fk_storyComt_story` FOREIGN KEY (`storyId`) REFERENCES `r_story` (`storyId`),
  CONSTRAINT `fk_storyComt_user` FOREIGN KEY (`userId`) REFERENCES `r_user` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_storycomt
-- ----------------------------

-- ----------------------------
-- Table structure for `r_storytype`
-- ----------------------------
DROP TABLE IF EXISTS `r_storytype`;
CREATE TABLE `r_storytype` (
  `storyTypeId` int(11) NOT NULL AUTO_INCREMENT,
  `storyTypeName` varchar(50) NOT NULL,
  PRIMARY KEY (`storyTypeId`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_storytype
-- ----------------------------
INSERT INTO `r_storytype` VALUES ('1', '美食');
INSERT INTO `r_storytype` VALUES ('2', '文化');
INSERT INTO `r_storytype` VALUES ('3', '景点');
INSERT INTO `r_storytype` VALUES ('4', '房源');
INSERT INTO `r_storytype` VALUES ('5', '店铺');
INSERT INTO `r_storytype` VALUES ('6', '活动');
...
CREATE TABLE `r_user` (
  ...
  `userAdress` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`userId`),
  KEY `fk_user_userType` (`userTypeId`),
  CONSTRAINT `fk_user_userType` FOREIGN KEY (`userTypeId`) REFERENCES `r_usertype` (`userTypeId`)
) ENGINE=InnoDB AUTO_INCREMENT=50 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_user
-- ----------------------------
INSERT INTO `r_user` VALUES ('3325623', '26', '123456', 'yhyyhy ', '女', '1998年1月1日 ', '123456 ', 'yhyyhy的个人中心\r\n												', '123456@qq.com', '/IMG_3623_1564620884263.JPG', '1', '厦门');
INSERT INTO `r_user` VALUES ('0', '27', '123456', 'gwjgwj ', '女', '1900年1月1日 ', '123456', '暂无简介', '000@000.com', '/IMG_3628_1564622543549.JPG', '1', '世界 ');
INSERT INTO `r_user` VALUES ('362637199712182938', '28', '123456', 'pjpjpj', '男', '1997年12月18日 ', '15315111326', '你可真是个带善人。', 'raymondpayne@126.com', '/sxc_1564569418063.jpg', '1', '地球村');
INSERT INTO `r_user` VALUES ('0', '29', '123456', 'qsyqsyqsy', '男', '1900年1月1日', '123456', '暂无简介', '000@000.com', null, '1', '世界');
INSERT INTO `r_user` VALUES ('0', '30', '123456', 'zyzyzy', '男', '1900年1月1日', '123456', '暂无简介', '000@000.com', null, '3', '世界');
INSERT INTO `r_user` VALUES ('0', '31', '123456', 'cjcjcj', '男', '1900年1月1日', '123456', '暂无简介', '000@000.com', null, '1', '世界');
INSERT INTO `r_user` VALUES ('0', '44', '123456', 'zyzyzyf', '男', '1900年1月1日', '123456', '暂无简介', '1430379325@qq.com', null, '4', '地球');
INSERT INTO `r_user` VALUES ('0', '45', '111222', 'teachers', '男', '1900年1月1日', '18273649389', '暂无简介', '000@000.com', null, '1', '世界');
INSERT INTO `r_user` VALUES ('0', '46', '123456', 'yhyyhyyhy', '男', '1900年1月1日', '18120810263', '暂无简介', '000@000.com', null, '1', '世界');
INSERT INTO `r_user` VALUES ('0', '47', '123456', 'yhyaa', '男', '1900年1月1日', '123456', '暂无简介', '000@000.com', '/default_head.jpg', '1', '世界');
INSERT INTO `r_user` VALUES ('0', '48', '123123', 'qwer', '男', '1900年1月1日', '12312312312', '暂无简介', '000@000.com', '/default_head.jpg', '1', '世界');
INSERT INTO `r_user` VALUES ('0', '49', '123456', 'yhyabc ', '女', '1900年1月1日 ', '123456', '暂无简介', '000@000.com', '/IMG_3623_1564627489875.JPG', '1', '世界 ');

-- ----------------------------
-- Table structure for `r_usertype`
-- ----------------------------
...
-- ----------------------------
-- Records of r_usertype
-- ----------------------------
INSERT INTO `r_usertype` VALUES ('1', '房客');
INSERT INTO `r_usertype` VALUES ('2', '房东');
INSERT INTO `r_usertype` VALUES ('3', '房源管理员');
INSERT INTO `r_usertype` VALUES ('4', '系统管理员');

-- ----------------------------
-- Table structure for `r_wish`
-- ----------------------------
DROP TABLE IF EXISTS `r_wish`;
CREATE TABLE `r_wish` (
  `userId` int(11) NOT NULL,
  `houseId` int(11) NOT NULL,
  KEY `fk_wish_user` (`userId`),
  KEY `fk_wish_house` (`houseId`),
  CONSTRAINT `fk_wish_house` FOREIGN KEY (`houseId`) REFERENCES `r_house` (`houseId`),
  CONSTRAINT `fk_wish_user` FOREIGN KEY (`userId`) REFERENCES `r_user` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of r_wish
-- ----------------------------
INSERT INTO `r_wish` VALUES ('27', '102');
